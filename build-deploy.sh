...
PROJECT_NAME="probe-application"
IMAGE_REGISTRY="quay.io"
IMAGE_ORG="rhoas"
IMAGE_TAG="${VERSION}"

PROBE_APPLICATION_IMAGE_NAME="srs-probe-application"
PROBE_APPLICATION_DOCKER_BUILD_COMMAND="docker build -f ./Dockerfile -t ${IMAGE_REGISTRY}/${IMAGE_ORG}/${PROBE_APPLICATION_IMAGE_NAME}:${IMAGE_TAG} ./"
...
main() { 
    ...
    # building images
    build_image "${PROBE_APPLICATION_IMAGE_NAME}" "${PROBE_APPLICATION_DOCKER_BUILD_COMMAND}"

    # logging to quay
    quay_login

    # pushing the images to quay
    push_image ${PROBE_APPLICATION_IMAGE_NAME}
